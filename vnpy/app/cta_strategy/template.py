...
class CtaTemplate(ABC):
    ...
    def buy(self, price: float, volume: float, stop: bool = False, lock: bool = False, account_id: str = ""):
        """
        Send buy order to open a long position.
        """
        return self.send_order(Direction.LONG, Offset.OPEN, price, volume, stop, lock, account_id)

    def sell(self, price: float, volume: float, stop: bool = False, lock: bool = False, account_id: str = ""):
        """
        Send sell order to close a long position.
        """
        return self.send_order(Direction.SHORT, Offset.CLOSE, price, volume, stop, lock, account_id)

    def short(self, price: float, volume: float, stop: bool = False, lock: bool = False, account_id: str = ""):
        """
        Send short order to open as short position.
        """
        return self.send_order(Direction.SHORT, Offset.OPEN, price, volume, stop, lock, account_id)

    def cover(self, price: float, volume: float, stop: bool = False, lock: bool = False, account_id: str = ""):
        """
        Send cover order to close a short position.
        """
        return self.send_order(Direction.LONG, Offset.CLOSE, price, volume, stop, lock, account_id)
    ...
    def send_order(
        ...
        if self.trading:
            vt_orderids = self.cta_engine.send_order(
                self, direction, offset, price, volume, stop, lock, account_id
            )
            return vt_orderids
        else:
            return []
